...
<head>
  <meta charset="UTF-8">
  <title>Edit Item - InventaX</title>
    ...
    <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse">
      <div class="position-sticky pt-3">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="${pageContext.request.contextPath}/inventory?action=list">
        ...
        <div class="card-body">
          <form action="inventory" method="post">
            ...
            <div class="mb-3">
              ...
              <input type="date" class="form-control" id="expiryDate" name="expiryDate" value="${item.expiryDate}">
