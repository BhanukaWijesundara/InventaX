...
<head>
    <meta charset="UTF-8">
    <title>Add Supplier - InventaX</title>
    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 main-content">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4 border-bottom border-secondary">
                <h2 class="h2">Add New Supplier</h2>
                        ...
                        <div class="card-body p-4">
                            <form action="suppliers" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-text">A unique identifier for the supplier (e.g., S001).</div>
                                </div>
                                ...
                                <div class="d-flex justify-content-end mt-4">
                                    ...
                                    <button type="submit" class="btn btn-primary"><i class="fas fa-save me-1"></i> Add Supplier</button>
                                </div>
                            </form>
                        </div>
                    </div>
